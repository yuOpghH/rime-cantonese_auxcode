...
使用倉頡/速成/標準兩分/改版兩分對RIME粵拼方案的外掛axu_code的lua的簡易部署方案。 Simple Deployment Guide for axu_code Lua Plugin with Cangjie/Sukeng/Standard Two-Part/Revised Two-Part Input Methods for RIME Cantonese Pinyin Scheme  cantonese / 廣東話 / 广东话 / 粵語 / 粤语 / 粵拼 / 粤拼
